...
import jay.demo.argumentResolver.ArgumentResolver;
...
@JayService("jayHandlerAdapter")
public class JayHandlerAdapter implements HandlerAdapterService {

    /**
     * @Description 对method方法里的参数进行处理
     * @Param [request, response, method, beans]
     * @Author Jay.Jia
    ...
    /**
     * @Description 获取实现了ArgumentResolver接口的所有实例(其实就是每个参数的注解实例)
     * @Param [beans, intfType]
     * @Author Jay.Jia
     * @Date 2021/1/18 16:01
